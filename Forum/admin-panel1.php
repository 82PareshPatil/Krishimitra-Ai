...
<html lang="en">
  <head>
	...
	<title>Krishimitra Forum Ai</title>
	<link rel="shortcut icon" type="image/x-icon" href="../img/logo (1).jpg"/>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i>Krishimitra Forum Ai</a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #62d464, darkgreen);
}
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-emp" id="list-emp-list"  role="tab"    aria-controls="home" data-toggle="list">Experts List</a>
      <a class="list-group-item list-group-item-action" href="#list-user" id="list-user-list"  role="tab" data-toggle="list" aria-controls="home">Farmers List</a>
      ...
      <a class="list-group-item list-group-item-action" href="#list-settings" id="list-adoc-list"  role="tab" data-toggle="list" aria-controls="home">Add Expert</a>
      <a class="list-group-item list-group-item-action" href="#list-settings1" id="list-ddoc-list"  role="tab" data-toggle="list" aria-controls="home">Delete Expert</a>
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Experts List</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Farmer List</h4>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Manage Experts</h4>
                    
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-adoc-list')">Add Experts</a>
                        &nbsp|
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  <div class="col-md-4"><label>Expert Name:</label></div>
