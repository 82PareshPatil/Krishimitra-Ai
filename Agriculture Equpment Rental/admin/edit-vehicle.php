...
<head>
	...
	<title>Krishimitra Ai Rental Portal | Admin Edit Vehicle Info</title>
...
<label class="col-sm-2 control-label">Work Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="inlineCheckbox1"> Hydraulic Lift System </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> Plow Attachment  </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3">Rotavator  </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Seed Drill </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Sprayer System  </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Trailer Hitch</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Four-Wheel Drive (4WD) </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Adjustable Tyre Width </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> PTO (Power Take-Off) </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Canopy or Cabin</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> GPS Guidance System </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Multi-Speed Transmission </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
