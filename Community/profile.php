                                ...
                                if($username == $added_by){
                                    ...
                                    $ret_str .= "
                                        ...
                                        <div calss='post_feature'>
                                            <span class='comment' style='color:rgb(56, 197, 77); font-size: 12px; float: right; margin-right: 40px; margin-top:-10px;'  onClick='javascript:toggle$id()'><i class='fas fa-comment fa-2x'></i>($comment_check_num)</span>&nbsp;&nbsp;
