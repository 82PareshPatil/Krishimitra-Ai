...
<div class="header_bar">
    <a href="index.php" style="text-decoration: none; color:rgb(68, 216, 100);"><img src="../img/logo (1).jpg" alt="O" style="height: 40px; width: 40px; margin: 18px 3px -10px 30px;">
    <span style="font-family: Roboto;/*! text-decoration: none; */font-size: 26px;">Krishimitra Ai</span></a>
  ...
  <a href="../Forum"> <i class="fas fa-user-tie fa-lg"></i></a>
